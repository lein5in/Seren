  ...
  return (
    <div className="min-h-screen bg-[#F8F8F6] flex flex-col items-center justify-center px-4">
      ...
      <div className="bg-white rounded-2xl border border-[#E1F5EE] shadow-[0_4px_32px_rgba(15,110,86,0.07)] w-full max-w-[400px] p-8">
        <h1 style={{ fontFamily: 'DM Serif Display, serif' }} className="text-[28px] text-[#04342C] font-normal mb-1">Create your account</h1>
        <p className="text-sm text-[#88877F] mb-7">Your study companion is ready when you are.</p>
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-[#4A4A47] uppercase tracking-wider">Name</label>
        ...
        <p className="text-sm text-[#88877F] text-center mt-6">
          ...
          <Link to="/login" className="text-[#0F6E56] font-medium no-underline hover:underline">Log in</Link>
        </p>
      </div>
    </div>
  )
